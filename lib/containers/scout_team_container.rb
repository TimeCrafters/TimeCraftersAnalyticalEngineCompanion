class ScoutTeamContainer < Container
  def setup
    ...
    set_layout_y(80, 47)
    _j = text "Can Score Jewel", 0, layout_y, 22
    _g = text "Can Score Glyphs", 0, layout_y, 22
    _c = text "Can Read Cryptobox Key", 0, layout_y, 22
    _s = text "Max Glyphs Scorable", 0, layout_y, 22
    _p = text "Can Park in Safe Zone", 0, layout_y, 22
